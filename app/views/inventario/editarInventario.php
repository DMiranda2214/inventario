        ...
        <form action="/inventario/public/Inventario/update" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="input-group">
                        <input type="text" name="inv_idProducto" value="<?= $inventario['pro_nombre'] ?>" class="form-control" id="inlineFormInputGroupProduct" placeholder="Producto" disabled>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <div class="input-group">
                        <input type="number" name="inv_Stock" value="<?= $inventario['inv_Stock'] ?>" class="form-control" id="inlineFormInputGroupStock" placeholder="Cantidad" disabled>
                    </div>
                </div>
                <div class="col-6">
