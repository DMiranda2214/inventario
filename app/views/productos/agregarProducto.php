        ...
        <form action="/inventario/public/Productos/insert" method="POST" class="form-horizontal">
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <div class="input-group">
                        <input type="text" name="pro_nombre" class="form-control" id="inlineFormInputGroupUsername" placeholder="Nombre del producto">
                    </div>
                </div>
                <div class="col-6">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="input-group">
                        <textarea type="text" name="pro_descripcion" class="form-control"  id="inlineFormInputGroupDescription" placeholder="Descripcion del producto"></textarea>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="pro_precioVenta" class="form-control" id="inlineFormInputGroupSellPrice" placeholder="Precio de venta">
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="pro_cantMin" class="form-control" id="inlineFormInputGroupInventoryMin" placeholder="Cantidad Minima (Default: 10)">
                    </div>
                </div>
            </div>
            <div class="row mb-3">
