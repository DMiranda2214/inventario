        ...
        <form action="/inventario/public/Productos/edit" method="POST" class="form-horizontal">
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <div class="input-group">
                        <input required type="text" name="pro_nombre" value="<?= $producto['pro_nombre'] ?>" class="form-control" id="inlineFormInputGroupUsername" placeholder="Nombre del producto">
                    </div>
                </div>
                <div class="col-6">
                    <label class="col-lg-3 control-label" for="inlineFormInputGroupCategoria">Categoria</label>
                    <div class="input-group">
                        <select required class="form-select" name="pro_idCategoria" id="inlineFormInputGroupCategoria">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div class="input-group">
                        <textarea required type="text" name="pro_descripcion" class="form-control"  id="inlineFormInputGroupDescription" placeholder="Descripcion del producto"><?= $producto['pro_descripcion']?></textarea>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <div class="input-group">
                        ...
                        <input required type="number" name="pro_precioVenta" value="<?= $producto['pro_precioVenta'] ?>" class="form-control" id="inlineFormInputGroupSellPrice" placeholder="Precio de venta">
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <div class="input-group">
                        ...
                        <input required type="number" name="pro_cantMin" value="<?= $producto['pro_minStock'] ?>" class="form-control" id="inlineFormInputGroupInventoryMin" placeholder="Cantidad Minima (Default: 10)">
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <input required type="text" hidden name="pro_id" value="<?= $producto['pro_id'] ?>">
