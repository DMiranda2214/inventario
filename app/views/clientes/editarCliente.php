        ...
        <form action="/inventario/public/Clientes/edit" class="form-horizontal" method="post">
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <div class="input-group">
                        <input type="text" name="cli_telefono" value="<?= $cliente['tCli_telefono'] ?>" class="form-control" id="inputClientTelefono" placeholder="Telefono del cliente">
                    </div>
                </div>
                <div class="col-6">
                    <label class="col-lg-3 control-label" for="inputClientDireccion">Direccion</label>
                    <div class="input-group">
                        <input type="text" name="cli_direccion" value="<?= $cliente['dCli_direccion'] ?>" class="form-control" id="inputClientDireccion" placeholder="Direccion del cliente">
                    </div>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <input type="text" hidden name="cli_id" value="<?= $cliente['cli_id'] ?>">
