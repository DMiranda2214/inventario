            ...
            <div class="card-body">
                <form class="form-horizontal" method="POST" action="/inventario/public/Categorias/edit" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="cat_nombre" required class="form-control" id="name" placeholder="Nombre" value="<?= $categoria['cat_nombre'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inlineFormInputCategoryDescription" class="col-lg-2 control-label">Descripcion</label>
                        <div class="col-md-6">
                            <textarea type="text" name="cat_descripcion" class="form-control"  id="inlineFormInputCategoryDescription" placeholder="Descripcion de la categoria"><?= $categoria['cat_descripcion']?></textarea>
                        </div>
                    </div>
                    <br>
                    <div class="form-group">
